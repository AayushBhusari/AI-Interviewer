...
const interviewTypeOptions = [
	...
	},
	{
		...
		label: "Technical",
		description:
			"Practice technical / problem-solving interview questions.",
					...
					<div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 mb-12">
						<div className="flex items-center justify-between gap-6 mb-6">
							<div>
								...
								<p className="text-zinc-400">
									Pick the format you want to practice, then
									start the session.
								</p>
							</div>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							{interviewTypeOptions.map((option) => {
								const isSelected =
									selectedInterviewType === option.key;
						...
						{loading ? (
							...
							<div className="bg-zinc-900 border border-zinc-800 rounded-xl p-12 text-center">
								...
								<p className="text-zinc-500 text-sm">
									Start your first interview to see results
									here
								</p>
							</div>
						) : (
